...
function AssassinFirst(cid, message, keywords, parameters, node) 
    ...
    if addon == -1 then 
        if getPlayerItemCount(cid,5812) >= 50 and getPlayerItemCount(cid,5910) >= 50 and getPlayerItemCount(cid,5911) >= 50 and getPlayerItemCount(cid,5913) >= 50 and getPlayerItemCount(cid,5914) >= 50 and getPlayerItemCount(cid,5909) >= 50 and getPlayerItemCount(cid,5886) >= 10 then 
        if doPlayerRemoveItem(cid,5812,50) and doPlayerRemoveItem(cid,5910,50) and doPlayerRemoveItem(cid,5911,50) and doPlayerRemoveItem(cid,5913,50) and doPlayerRemoveItem(cid,5914,50) and doPlayerRemoveItem(cid,5909,50) and doPlayerRemoveItem(cid,5886,10) then 
            selfSay(newaddon, cid) 
...
keywordHandler:addKeyword({'help'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = "What you do is that you type 'first hunter addon' or 'second hunter addon' where you replace 'hunter' with whatever outfit you'd like to achieve the addons for. Assuming that you already collected all the required pieces, say 'yes' and voíla - you got yourself an addon!"}) 
 ...
 node41 = keywordHandler:addKeyword({'first demonhunter addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the first demonhunter addon you need to give me 30 vampire dusts, 40 demon dusts, 50 demon horns, 50 demonic essence and 100 talons. Do you have them with you?'}) 
    node41:addChildKeyword({'yes'}, DemonhunterFirst, {}) 
 ...
 node42 = keywordHandler:addKeyword({'second demonhunter addon'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = true, text = 'To achieve the second demonhunter addon you need to give me 50 demon dusts, 200 demonic essence and 100 talons. Do you have them with you?'}) 
    node42:addChildKeyword({'yes'}, DemonhunterSecond, {}) 
